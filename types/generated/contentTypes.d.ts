...
export interface ApiHouseHouse extends Schema.CollectionType {
  ...
  attributes: {
    television: Attribute.String;
    led: Attribute.String;
    animal: Attribute.RichText;
    cat: Attribute.Media;
    datajson: Attribute.JSON;
    number: Attribute.UID<'api::house.house', 'led'>;
...
export interface ApiI18NI18N extends Schema.CollectionType {
  ...
  attributes: {
    ...
    platform: Attribute.Enumeration<['web', 'mobi', 'extension']>;
    en: Attribute.String;
    vi: Attribute.String;
    zh: Attribute.String;
    ja: Attribute.String;
...
export interface ApiI18NAnotherVersionI18NAnotherVersion
  extends Schema.CollectionType {
  collectionName: 'i18n_another_versions';
  info: {
    singularName: 'i18n-another-version';
    pluralName: 'i18n-another-versions';
    displayName: 'i18n_another_version';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::i18n-another-version.i18n-another-version',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiI18NV3I18NV3 extends Schema.CollectionType {
  collectionName: 'i18n_v3s';
  info: {
    singularName: 'i18n-v3';
    pluralName: 'i18n-v3s';
    displayName: 'i18n_v3';
  };
  options: {
